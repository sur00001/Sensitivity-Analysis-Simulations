...
source("05a-SimpleLogAnalysis.R")
#load("~/Sensitivity Analysis - Paper 1/Delta-adjusted-sensitivity-analysis/truthRefMeans.rda") #true regime means (from monte carlo sim using mbridge sim models)
# Null regime means (monte carlo sim using mbridge sim models but I made the treatment effect coefficients 0)
...
clusterExport(cl, c("run.sim","induce.missYt","gen.data","abs","mean",
                    ...
                    "expit","logbinge.mod","logbinge.mod1","logbinge.mod2","greek.mod1","hs.mod","hs.mod1","hs.mod2",
                    "logsmbinge.mod","predict","is.na","which","logit","%>%",
